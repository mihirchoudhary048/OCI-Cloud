...
def fetch_policies():
    try:
        # Fetch tenancy OCID from environment variables
        tenancy_ocid = os.getenv('OCI_TENANCY')  # Automatically fetch tenancy OCID
        if not tenancy_ocid:
            raise Exception("Tenancy OCID not found. Please check your environment setup.")
